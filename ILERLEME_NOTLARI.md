...
- Not: kullanıcının gerçek cihazda YENİ BUILD ile test etmesi gerekenler: sohbetin dipten açılması, foto yükleme balonu, mesaj silme (tekli + çoklu seçim), ilan sil/düzenle (tekli + çoklu seçim).
